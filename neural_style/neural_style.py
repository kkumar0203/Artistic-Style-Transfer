...
def main():
    ...
    train_arg_parser.add_argument("--checkpoint-interval", type=int, default=50,
...
# python neural_style/neural_style.py train --dataset </path/to/train-dataset> --style-image </path/to/style/image> --save-model-dir </path/to/save-model/folder> --epochs 2 --cuda 0